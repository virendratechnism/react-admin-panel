		...
		<>
			...
			<div className="">
				<table className='my-3 mx-5 ' style={{ border: '1px solid' }}>
					...
					<tr style={{ border: '1px solid' }}>
						<td style={{ border: '1px solid' }}>Centro comercial Moctezuma</td>
					...
					<tr style={{ border: '1px solid' }}>
						<td style={{ border: '1px solid' }}>Laughing Bacchus Winecellars</td>
						<td style={{ border: '1px solid' }}>Yoshi Tannamuri</td>
						<td style={{ border: '1px solid' }}>Canada</td>
					</tr>
					<tr style={{ border: '1px solid' }}>
						<td style={{ border: '1px solid' }}>Magazzini Alimentari Riuniti</td>
...
const About = () => {
	...
	return (
		<>
			<h1>About Page</h1>
			{/* <p>About Page</p> */}
			<Card className='shadow my-3 mx-5' style={{ borderTop: "3px solid #f39c12", padding: '20px 15px', maxWidth: '25em' }}>
				<Table>
					<thead>
						<h4>Opening Hours</h4>
					</thead>
					...
					<tfoot>
						<button className='btn btn-success my-3 mx-5' onClick={() => navigate(-1)}>Back</button>
					</tfoot>
				</Table>
			</Card>
		</>
